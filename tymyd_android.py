...
def doPinglun(momentId):
	...
	url = "https://apps.game.qq.com/wuxia_cgi/ZoneTranspondCgi/index.php?act=requestTranspond&sMethodPath=/api/moment/addcomment&callback=jQuery17108402774150402388_1590{}&uin={}&userId={}&roleId=1318055637&text=1&momentId={}&replyCommentId=0"
	headers = {
	...
	try:
		...
		for i in range(10):
			if (str(data_list[i]['userId'])+" add\n") not in getTxtid():
				inputTxtid(data_list[i]['userId']+" add")
